...
the output is  'true'.
The second one is Query-2: It pops the data from the stack. Since at this point in time,
no data exist in the stack hence, it prints -1.
The third one is Query-1: It pushes the specified data 10 into the stack and since the function doesn't
return anything, nothing is printed.
...
class Stack:
    ...
    def __init__(self):         # for developer only not for users
        self.__head = None
        self.__count = 0
...
# main
print("Enter the number of queries to be run against each operation in the stack.")
