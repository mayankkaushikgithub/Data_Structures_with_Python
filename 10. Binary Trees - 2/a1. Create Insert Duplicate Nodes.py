...
Just implement the function to achieve the desired structure of the tree.
Constraints :       1 <= N <= 10^5      Where N is the total number of nodes in the binary tree.
Time Limit: 1 sec

Sample Input 1:     10 20 30 40 50 -1 60 -1 -1 -1 -1 -1 -1
Sample Output 1:    10
                    10 30
                    20 30 60
                    20 50 60
...
Sample Input 2:     8 5 10 2 6 -1 -1 -1 -1 -1 7 -1 -1
Sample Output 2:    8
                    8 10
                    5 10
                    5 6
...
def insertDuplicateNode(root):
    ...
    duplicateData = root.data                           # copy the data of root node
    duplicateNode = BinaryTreeNode(duplicateData)       # make a duplicate node from copied data

    temp = root.left                    # break the connection of left node, pt. it towards temp ptr
    root.left = duplicateNode           # change original left ptr to duplicate node
    duplicateNode.left = temp           # pt left of duplicate node to old left node
