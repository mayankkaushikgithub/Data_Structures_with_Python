...
Sample Input 1 :    2                       Sample Output 1 :   a b
                                                                a c
                                                                b c
Sample Input 2 :    3                       Sample Output 2 :   a c
                                                                a b
                                                                c b
                                                                a c
                                                                b a
...
def towerofhanoi(n, source, aux, dest):
    ...
    towerofhanoi(n-1, source, dest, aux)        # means move n-1 disks from source to aux using dest
    print("Move", n, " th disk from", source, " to ", dest)
    towerofhanoi(n-1, aux, source, dest)        # move n-1 disk from aux to dest using source
