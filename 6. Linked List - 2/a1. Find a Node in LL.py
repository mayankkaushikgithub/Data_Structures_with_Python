...
first occurrence of 'n' in the linked list. -1 otherwise. Follow a recursive approach to solve this.
...
# def findNodeRec(head, n):               # ITERATIVE SOLUTION
#     if head is None:
...
while t > 0:
    ...
    print("\nEnter the Node Value you want to search for: ")
    n = int(stdin.readline().rstrip())

    print(f"\nNode {n} (you searched for) is present at: ")
